...
.websockets: websockets .zlib toolchain.cmake
	cd $< && $(HOSTVARS) CFLAGS="$(CFLAGS) $(EX_ECFLAGS)" $(CMAKE) -DLWS_WITH_SSL=0 -DLWS_WITHOUT_TEST_PING=1 -DLWS_WITHOUT_TEST_SERVER_EXTPOLL=1 -DLWS_WITHOUT_TEST_SERVER=1 -DLWS_WITHOUT_TEST_FRAGGLE=1 -DLWS_WITHOUT_TEST_CLIENT=1 -DLWS_WITHOUT_TESTAPPS=1 -DLWS_IPV6=1 $(make_option)
